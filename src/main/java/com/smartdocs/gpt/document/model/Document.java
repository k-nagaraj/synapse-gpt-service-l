...
import static com.smartdocs.gpt.document.util.Utils.quoted;
import static com.smartdocs.gpt.document.util.ValidationUtils.ensureNotBlank;
...
public class Document {
	 ...
	 * @return the metadata value for the given key, or null if the key is not
	 *         present.
	 */
	...
	public String toString() {
		return "Document {" + " text = " + quoted(text) + " metadata = " + metadata.asMap() + " }";
	}
