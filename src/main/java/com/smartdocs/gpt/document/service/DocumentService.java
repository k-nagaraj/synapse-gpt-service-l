...
import com.smartdocs.gpt.service.AzureTenantBlobService;
...
public class DocumentService {
	...
	private final AzureTenantBlobService azureTenantBlobService;


	public Map<Integer, Document> processDocument(TrainDocumentRequest trainDocumentRequest) {
		...
		if (TrainDocumentRequest.DOCUMENT_FILE_CATEGORY.equalsIgnoreCase(documentCategory)) {
			...
			byte[] bytes = azureTenantBlobService.getFile(trainDocumentRequest.getResourceId());
